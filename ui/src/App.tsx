...
function formatRegret(value: number | null | undefined): string {
  return value === null || value === undefined ? "-" : `${value} cp`;
}

function stockfishStatusLabel(status: ToolStatus | null): string {
  if (!status) {
...
function formatStockfishScore(stockfish: NonNullable<ToolAnalysis["stockfish"]>): string {
