...
from chess_llm.external.stockfish import StockfishWrapper

logger = logging.getLogger(__name__)

_EMPTY_ANNOTATION = {"cp": None, "mate": None, "best_move": None, "pv_line": ""}
