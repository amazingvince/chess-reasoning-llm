...
> Research/design proposal. This file was moved from `plan/` during the
> 2026-07-04 docs cleanup. Current commands, task counts, and package paths are
> governed by `src/chess_llm/`, `docs/index.md`, and active runbooks.

Status: design proposal (2026-07-03). Companion to
`docs/archive/original_sft_plan/03_phase_c_planning.md` (what tier 7 becomes),
`docs/archive/original_sft_plan/05_sdpo_handoff.md` and
`docs/research/sdpo.md` (what consumes the trace channel), and
`docs/experiments/runs/2026-07-03_tmp_run_results.md` (the empirical
constraints). This document is the data-side answer to "where do reasoning
traces come from and how do we know they're working."
